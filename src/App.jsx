            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {caseStudies.map((cs, idx) => (
                <CaseStudyCard
                  ...
                  labels={caseLabels}
                  onOpenDemo={
                    cs.demo ? () => setActiveDemo(cs.demo) : undefined
                  }
                />
              ))}
            </div>
      ...
      <AnimatePresence>
        {activeDemo ? (
          ...
          >
            ...
            >
              <div
                className="sticky top-0 z-10 flex items-center justify-between gap-4 px-6 py-4 border-b border-white/10 bg-slate-900/90 backdrop-blur-md
